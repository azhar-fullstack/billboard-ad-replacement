...
Usage:
  python src/replace_video.py --video-in assets/video.mp4 --ad assets/sample_ad.webp --out demos/replaced_video.mp4
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--weights", type=str, default=str(root / "weights" / "best_seg.pt"))
    p.add_argument("--video-in", type=str, default=str(root / "assets" / "video.mp4"))
    p.add_argument(
        "--ad",
        nargs="+",
        type=str,
    ...
    p.add_argument("--out", type=str, default=str(root / "demos" / "replaced_video.mp4"))
